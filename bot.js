...
/*  
  const bannedwords = [ 	///////وصف الكود: الكود يمنع اوامر البوت فى الشات يعطى تحذير اول بعدها يعطى ميوت اذا سواها مره ثانيه 
							// 	او ممكن تستعملو فى منع السب
							//لا تنسى تسوى رول warn و muted
...
client.on('message', message => { /// 
  ...
  if(message.channel.id !== '476700757975105539') return;
  if (message.author.bot) return;
 ...
 //*نبذة عن الكود : 
/*كود إعطاء وسحب رتبة من الشخص وحتى البوتات 
-------------------------------------------------------
...
Faisal07/27/2018
مع العلم ان اي شخص معه مانج رولز يقدر يعطي اي رول بالحياه يعني لو البوت الرول حقه فوق مره فوق رتبتك اللي مفتوح فيها كل الخواص بالكوكب يقدر ياخذها، اللي يبي يستعمله يخلي البرمشن بالايدي او ادمنستريشن بدل مانج رولز او يعدلها بمعرفته عاد بكيفكم بس قلت احذركم
*/
//---------------------------------------------------------------------------------
